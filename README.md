...
```bash
conda create -n usecase2 python=3.9
...
```
This command will create your personal repository under `/Repos/<username>/usecase2`.
...
- To trigger the release pipeline, get the current version from the `usecase2/__init__.py` file and tag the current code version:
```
